...
add_meta('Para: ', 'martica@..., katherine.monsalve@..., william.nieto@..., jeffrey@..., john.jairo@..., ismelda@..., sergio@..., jhonatan.benavides@..., elisa@..., laura@..., katherine.rodriguez@..., daniela@...')
...
assignments = [
    ...
    ('Katherine Rodriguez + Daniela', 'Administración'),
]
